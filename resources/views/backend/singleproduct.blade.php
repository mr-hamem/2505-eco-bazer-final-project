            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                        <input type="text" class="form-control border-success-focus" id="name" name="name"
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select border-success-focus" id="brand_id" name="brand_id" required>
                        <option value="">Select Brand</option>
                        <option value="1" selected>Family (farmfresh)</option>
                ...
                <div class="col-md-6">
                    <label for="class" class="form-label fw-semibold text-dark">Class (e.g., Organic, Premium)</label>
                    <input type="text" class="form-control border-success-focus" id="class" name="class"
                           value="64% Off" placeholder="e.g., Fresh, Organic">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" class="form-control border-success-focus" id="price" name="price"
                               value="17.28" placeholder="0.00">
                    </div>
                    <small class="text-muted text-decoration-line-through">Original: $48.00</small>
                </div>
                ...
                <div class="col-12">
                    ...
                    <select class="form-select border-success-focus" id="tags" name="tags[]" multiple size="4">
                        ...
                        <option value="4" selected>Cabbage</option>
                        <option value="5" selected>Green Cabbage</option>
                        <option value="6">Organic</option>
                        <option value="7">Fresh</option>
                    </select>
                    <small class="text-muted d-block mt-1"><i class="bx bx-info-circle me-1"></i>Hold Ctrl/Cmd to select multiple tags.</small>
                </div>

                <div class="col-12">
                    <label for="image" class="form-label fw-semibold text-dark">Product Image</label>
                    <input type="file" class="form-control border-success-focus mb-3" id="image" name="image" accept="image/*">
                    ...
                    <div class="d-flex align-items-start gap-3 p-3 bg-light rounded border border-dashed">
                        <div class="thumbnail-gallery d-flex flex-column gap-2" style="width: 60px;">
                            <div class="border rounded p-1 bg-white border-success"><img src="https://via.placeholder.com/50" alt="thumb" class="img-fluid rounded"></div>
                            <div class="border rounded p-1 bg-white opacity-50"><img src="https://via.placeholder.com/50" alt="thumb" class="img-fluid rounded"></div>
                            <div class="border rounded p-1 bg-white opacity-50"><img src="https://via.placeholder.com/50" alt="thumb" class="img-fluid rounded"></div>
                        </div>
                        <div class="main-preview-box border rounded p-2 bg-white flex-grow-1 text-center" style="max-width: 250px;">
                            <img src="https://via.placeholder.com/200" alt="Chinese Cabbage Main Image" class="img-fluid rounded">
                ...
                <div class="col-12">
                    <div class="form-check form-switch card-accent-green">
                        ...
                        <input class="form-check-input check-input-success" type="checkbox" id="is_active" name="is_active" value="1" checked>
                ...
                <div class="col-12 mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-success btn-md px-4 py-2 fw-semibold shadow-sm text-white" style="background-color: #2cba59; border-color: #2cba59;">
