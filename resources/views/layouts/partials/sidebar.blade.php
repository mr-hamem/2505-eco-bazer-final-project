<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" style="background-color: #ffffff !important; font-family: 'Poppins', 'Inter', sans-serif;">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- operations center -->
        <li class="menu-header small text-uppercase" style="color: #00b207; font-weight: 600; letter-spacing: 0.5px;"><span class="menu-header-text">Operations Center</span></li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle" style="color: #1a1a1a;">
                ...
                <div data-i18n="User interface">Report</div>
            </a>
          ...
          <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle" style="color: #1a1a1a;">
                <i class="menu-icon tf-icons bx bx-box" style="color: #666666;"></i>
                <div data-i18n="User interface">Setting</div>
            </a>
