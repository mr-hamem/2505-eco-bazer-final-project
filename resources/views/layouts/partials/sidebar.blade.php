<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" style="background-color: #ffffff !important; font-family: 'Poppins', 'Inter', sans-serif;">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ activeLink('admin.instagram.home')  }}">
            <a href="{{ route('admin.instagram.home') }}" class="menu-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    fill="currentColor" viewBox="0 0 24 24" class="menu-icon tf-icons bx bxl-instagram">
                ...
                <div data-i18n="Analytics">Instagram</div>
            </a>
        </li>
