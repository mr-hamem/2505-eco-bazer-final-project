...
<head>
    ...
    <title>@yield('title') - EcoBazar</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" class="template-customizer-core-css"
        href="{{ asset('backend/assets/vendor/css/core.css') }}" />
    <link rel="stylesheet" class="template-customizer-theme-css"
        href="{{ asset('backend/assets/vendor/css/theme-default.css') }}" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <!-- Menu -->
            @include('layouts.partials.customerSidebar')
            <!-- / Menu -->
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <span class="fw-semibold d-block">
                                    {{ str()->headline(auth('customer')->user()->name) }}
                                </span>
                            </li>
                                        ...
                                        <a class="dropdown-item" href="{{ route('customer.dashboard') }}">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">{{
                                                        str()->headline(auth('customer')->user()->name) }}</span>
