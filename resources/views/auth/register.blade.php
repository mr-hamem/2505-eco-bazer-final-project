...
<head>
    ...
    <title>Sign In to EcoBazar</title>
        ...
        <div class="offCanvas d-lg-none d-flex">
            <div class="mblNavBtn">
                ...
                <div class="offcanvas offcanvas-start" tabindex="1" id="offcanvasLeft"
                    ...
                    <div class="offcanvas-header">
                        <a href="#"><img src="./img/Logo.png" class="offcanvas-title img-fluid" id="offcanvasLeftLabel"
                                alt=""></a>
            ...
            <div class="mblCartBtn">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasRightLabel">Purchase item <img src="./img/plant 1.png"
                                class="img-fluid"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body">
